 ...
 *
 * Deux familles, et la frontière compte : les outils du CARNET remplissent le
 ...
 * Tous portent les droits du jeton — aucun n'ouvre une porte que l'application
 * n'ouvrirait pas au même compte.
 */
